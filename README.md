...
$$
M = cK
\qquad \text{with } c = \mathrm{M_factor} > 0,
$$

then $K$ obeys the quadratic equation

$$
cK^2 - \bigl((c+d_{\mathrm{eff}}) + cE^2 d_{\mathrm{eff}}\bigr)K + \bigl(d_{\mathrm{eff}} + E^2 d_{\mathrm{eff}}\bigr) = 0,
$$
...
* \sqrt{
  \bigl((c+d_{\mathrm{eff}}) + cE^2 d_{\mathrm{eff}}\bigr)^2

- 4c\bigl(d_{\mathrm{eff}} + E^2 d_{\mathrm{eff}}\bigr)
  }
  }{2c}.
  $$
...
$$
\operatorname{Var}(\eta_i) \approx (K-1)\epsilon^2.
$$
...
$$
K
= 1 + \frac{E^2}{\dfrac{M-d_{\mathrm{eff}}}{d_{\mathrm{eff}}(M-1)}}
= 1 + \frac{E^2 d_{\mathrm{eff}}(M-1)}{M-d_{\mathrm{eff}}}.
$$
...
$$
\epsilon^2 = \frac{cK-d_{\mathrm{eff}}}{d_{\mathrm{eff}}(cK-1)}
$$
...
$$
E^2 = (K-1)\frac{cK-d_{\mathrm{eff}}}{d_{\mathrm{eff}}(cK-1)}.
$$

Multiplying through by $d_{\mathrm{eff}}(cK-1)$ gives

$$
E^2 d_{\mathrm{eff}}(cK-1) = (K-1)(cK-d_{\mathrm{eff}}).
$$

Expand both sides:

$$
cE^2 d_{\mathrm{eff}} K - E^2 d_{\mathrm{eff}}
= cK^2 - (c+d_{\mathrm{eff}})K + d_{\mathrm{eff}}.
$$
...
* \bigl((c+d_{\mathrm{eff}}) + cE^2 d_{\mathrm{eff}}\bigr)K

- \bigl(d_{\mathrm{eff}} + E^2 d_{\mathrm{eff}}\bigr).
  $$
...
\mathcal{N}!\left(
0,
(K-1)\frac{M-d_{\mathrm{eff}}}{d_{\mathrm{eff}}(M-1)}
\right).
$$
...
$$
\alpha \approx \mathcal{N}(0,\epsilon^2),
\qquad
\epsilon^2 \approx
\max!\left(
0,
